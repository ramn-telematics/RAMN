...
# Two independent chains now, because the handshake moved out of the screen
...
RAMN_SecOC_LINK_ProcessRxCANMessage,HandleSessionResponse,RAMN_SecOC_SESSION_Derive,RAMN_BLAKE2S_Update,blake2s_compress"
